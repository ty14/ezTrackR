#' Example Cup Dataset
#'
#' Cup dataset is the raw output from python after tracking social approach in an box with novel or familiar animals under a mesh cup.
#'
...
#'   \item{OTher}{T/F; T= object tracking in Cup ROI, F= object tracking not in Cup ROI }
#'   \item{ROI_coordinates}{Coordinates of the box and cup}
#' }
"cup"
